...
class GastosprogramacionjuegosDto {
  final int idGastoJuego;
  ...
  GastosprogramacionjuegosDto(
      {required this.idGastoJuego,
  ...
  factory GastosprogramacionjuegosDto.fromJson(Map<String, dynamic> json) {
    var serializer = const JsonSerializer();
    return GastosprogramacionjuegosDto(
      idGastoJuego: serializer.fromJson<int>(json['idGastoJuego']),
      idProgramacionJuego:
